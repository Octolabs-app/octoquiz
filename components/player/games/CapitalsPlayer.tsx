...
interface Props { state: CapitalsState; me: Player; socket: Socket<ServerToClientEvents, ClientToServerEvents> }

const OPTION_COLORS = ['#3b82f6', '#ef4444', '#22c55e', '#eab308']
const OPTION_LABELS = ['A', 'B', 'C', 'D']

export default function CapitalsPlayer({ state, me, socket }: Props) {
  ...
  function handleAnswer(opt: string) {
    ...
    setSelected(opt)
    socket.emit('game_action', { type: 'capitals_answer', answer: opt })
  }
